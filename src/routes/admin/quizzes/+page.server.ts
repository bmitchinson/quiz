...
export const actions: Actions = {
	addQuiz: async ({ request, cookies }) =>
		validatePasswordAndRefreshCookie(request, cookies, async () => {
			...
			// Step 1: Remove all characters except numbers, operators (+, -, *, /), parentheses, and newlines
			...
			// Step 4: Ensure one space before and after each operator (+, -, *, /)
			questionData = questionData.replace(/\s*([+\-*/])\s*/g, ' $1 ');
